<%-- 
    Document   : admin
    Created on : Mar 8, 2021, 10:32:03 AM
    Author     : PC
--%>
...
<head>
  ...
  <meta name="description" content="Sleek Dashboard - Free Bootstrap 4 Admin Dashboard Template and UI Kit. It is very powerful bootstrap admin dashboard, which allows you to build products like admin panels, content management systems and CRMs etc.">
        ...
        <title>Ecomerce Dashboard</title>

        <link href="https://fonts.googleapis.com/css?family=Montserrat:400,500|Poppins:400,500,600,700|Roboto:400,500" rel="stylesheet"/>
        <link href="https://cdn.materialdesignicons.com/3.0.39/css/materialdesignicons.min.css" rel="stylesheet" />

        <link rel="stylesheet" href="<c:url value="/resources-management/plugins/nprogress/nprogress.css"/>"/>
        <link rel="stylesheet" href="<c:url value="/resources-management/plugins/jvectormap/jquery-jvectormap-2.0.3.css"/>"/>
        <link rel="stylesheet" href="<c:url value="/resources-management/plugins/toaster/toastr.min.css"/>"/>
        <link rel="stylesheet" href="<c:url value="/resources-management/plugins/daterangepicker/daterangepicker.css"/>"/>

        <link rel="stylesheet" href="<c:url value="/resources-management/css/sleek.css"/>"/>
    ...
    <body class="header-fixed sidebar-fixed sidebar-dark header-light" id="body">
        ...
        <script src="<c:url value="/resources-management/js/sleek.bundle.js"/>"></script>
